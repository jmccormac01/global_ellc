...
#colnames_plot = ['r_1','r_2','incl']
colnames_plot = ['r_1', 'r_2', 'incl', 'T_0', 's_1_1', 'l_1_1', 'b_1_1', 'f_1_1',]
#labels_plot = ['$r_1$','$r_2$','$i [^{\circ}]$','$s$','$l_2/l_1$']
#labels_plot = ['$r_1$','$r_2$','$i [^{\circ}]$']
labels_plot = ['$r_1$','$r_2$','$i [^{\circ}]$', '$T_0$', '$s_1$', '$l_1$', '$b_1$', '$f_1$']
